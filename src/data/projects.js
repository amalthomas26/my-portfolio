export const projects = [
    {
        id: "traveller-api",
        title: "Traveller API",
        description: "Scalable REST API with jwt authentication,rbac,rate limiting,without any type using typescript  , custom loggin and error handling , also made it as a container using docker, custom loggin and error handling , also made it as a container using docker",
    ...
    },
    {
        ...
        description: "user management system with graphql api using apollo server,jwt auth and rbac , also basic pagination",
