      ...
      <div className="mx-auto max-w-6xl rounded-2xl border border-black/10 dark:border-white/10 bg-white/80 dark:bg-zinc-900/80 backdrop-blur-xl shadow-lg">
        <div className="flex h-14 items-center justify-between px-6">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm font-medium">
            <a href="#projects" className="text-zinc-700 dark:text-zinc-300 hover:text-black dark:hover:text-white transition">
              Projects
            </a>
            <a href="#skills" className="text-zinc-700 dark:text-zinc-300 hover:text-black dark:hover:text-white transition">
              Skills
            </a>
            <a href="#contact" className="text-zinc-700 dark:text-zinc-300 hover:text-black dark:hover:text-white transition">
              Contact
            </a>
          </nav>
              ...
              <SheetContent side="right" className="dark:bg-zinc-900">
                <nav className="mt-10 flex flex-col gap-6 text-lg font-medium">
                  ...
                  <button
                    ...
                    className="mt-4 rounded-xl bg-linear-to-r from-violet-600 to-blue-500 px-4 py-2 text-white"
                  >
                    Download Resume
                  </button>
                </nav>
